...
## Black listed words to check for in the reviews
blacklist = [
"nigger",
"gay",
"lesbians",
...
class Reviews(Resource):
    ...
    def get(self, review_text):
        ...
        ## mine the review text to check for objectionable content
        ...
        ## Find the intersection between the words in the document and the blacklist set
